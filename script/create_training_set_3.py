...
cloud = point_cloud.LoadPcd(os.path.dirname(__file__) + '/../data/pcd/shelf_s.pcd')
T = np.eye(4)
T[0:3, 0] = [0, 1, 0]
T[0:3, 1] = [-1, 0, 0]
T[0:3, 2] = [0, 0, 1]
...
def create_data():
    ...
    f_3d = os.path.dirname(__file__) + '/../data/npy/edge_shelf_3d.npy'
    f_2d = os.path.dirname(__file__) + '/../data/npy/edge_shelf_2d.npy'
    try:
        old_3d = np.load(f_3d)
        if old_3d.shape[0] != 0:
