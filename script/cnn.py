...
f = os.path.dirname(__file__) + '/../data/npy/normal_shelf_2d.npy'
data = np.load(f)
data_normal = np.vstack((data_normal, data))

f = os.path.dirname(__file__) + '/../data/npy/normal_shelf1_2d.npy'
data = np.load(f)
data_normal = np.vstack((data_normal, data))
...
f = os.path.dirname(__file__) + '/../data/npy/edge_shelf1_2d.npy'
data = np.load(f)
data_edge = np.vstack((data_edge, data))

f = os.path.dirname(__file__) + '/../data/npy/edge_shelf2_2d.npy'
data = np.load(f)
data_edge = np.vstack((data_edge, data))
...
if USE_CUDA:
    training_data = torch.cat((torch.FloatTensor(training_normal),
                               torch.FloatTensor(training_edge))).cuda()
    ...
    test_data = torch.cat((torch.FloatTensor(test_normal),
                           torch.FloatTensor(test_edge))).cuda()
...
if __name__ == '__main__':
    ...
    i = raw_input('save?')
    if i == 'y':
        f = os.path.dirname(__file__) + '/../model/cnn'
        torch.save(cnn, f)
