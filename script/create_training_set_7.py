...
cloud = point_cloud.LoadPcd(os.path.dirname(__file__) + '/../data/pcd/cloud6.pcd')
...
def create_data():
    ...
    # grasps = filter(lambda g: g.bottom[1] < 1.1, grasps)
    ...
    f_3d = os.path.dirname(__file__) + '/../data/edge_shelf2_3d.npy'
    f_2d = os.path.dirname(__file__) + '/../data/edge_shelf2_2d.npy'
    try:
        old_3d = np.load(f_3d)
        if old_3d.shape[0] != 0:
