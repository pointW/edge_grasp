...
cloud = point_cloud.LoadPcd(os.path.dirname(__file__) + '/../data/pcd/cloud5.pcd')
...
def create_data():
    ...
    f_3d = os.path.dirname(__file__) + '/../data/edge_shelf1_3d.npy'
    f_2d = os.path.dirname(__file__) + '/../data/edge_shelf1_2d.npy'
    try:
        old_3d = np.load(f_3d)
        if old_3d.shape[0] != 0:
