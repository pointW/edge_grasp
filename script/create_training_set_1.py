"""
cloud1 just contains the table
"""
# python
import os
...
cloud = point_cloud.LoadPcd(os.path.dirname(__file__) + '/../data/pcd/cloud1.pcd')
...
def create_data():
    ...
    f_3d = os.path.dirname(__file__) + '/../data/npy/edge_table1_3d.npy'
    f_2d = os.path.dirname(__file__) + '/../data/npy/edge_table1_2d.npy'
    try:
        old_3d = np.load(f_3d)
        if old_3d.shape[0] != 0:
